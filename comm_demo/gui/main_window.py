...
from comm_demo.core.constants import DEFAULT_TEXT, SPS
...
from .plotting import (
    ...
    ANALYSIS_NFFT,
    ANALYSIS_TIME_PLOT_POINTS,
    ANALYSIS_TIME_WINDOW,
    ANALYSIS_WELCH_OVERLAP,
    ANALYSIS_WELCH_SEGMENT,
    PlotCanvas,
    _audio_activity_window,
    _center_window,
    _downsample_for_plot,
    _random_sample_for_plot,
    _welch_spectrum_db,
)
from .workers import StepWorker
